...
- **Next recommended increment:** Complete XML-to-JSON for JavaScript (P6), focusing on attributes, namespaces, repeated elements, file workflows and usable JS output.
