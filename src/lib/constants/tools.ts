...
export const TOOLS: Tool[] = [
  ...
  {
    id: "line-sort",
    name: "Line Tools: Trim, Dedupe & Sort",
    description: "Trim whitespace, remove blanks and duplicates, then sort text alphabetically, naturally or numerically. Includes file input, exact stats and export.",
    shortDescription: "Satırları trimle, tekilleştir ve sırala",
    category: "text",
    path: "/tools/line-sort",
    seoKeyword: "line tools trim dedupe sort text",
    icon: "📋",
    isNew: true,
  },
  {
  ...
  },
  {
    ...
    name: "QR Code Generator — URL, Wi-Fi & vCard",
    description: "Create validated QR codes for URLs, Wi-Fi, vCards, email, SMS, phone, and text. Preview the exact payload and download PNG or SVG locally.",
    shortDescription: "URL, Wi-Fi, vCard ve mesajlar için doğrulanmış QR kod üret",
    category: "generators",
    path: "/tools/qr-code-generator",
    seoKeyword: "qr code generator wifi vcard",
    icon: "📱",
    isNew: true,
    isPopular: true,
  },
